...
<br>
When you run docker exec -it, and try to execute commands such as `ping` and `curl` it won't work, since alpine OS is a lightweight OS with not much of a tools in it.# Container
